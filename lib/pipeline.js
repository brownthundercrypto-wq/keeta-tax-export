...
const { classifyStaple, REASONS, DUST_THRESHOLD_KTA, extractFeeLegs, stripFeeEntries } = _cls;
const { resolveTokens } = _tok;
const { resolveAnchors } = _anc;
...
const API = {
	...
	collectOutgoingCounterparties, prefetchAnchors,
