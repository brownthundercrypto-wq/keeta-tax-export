...
function explainReason(reason) {
	switch (reason) {
		...
		case REASONS.NO_TIMESTAMP:
			return ('The network timestamp for these could not be read, so they cannot be placed in a tax year. They are excluded. This is unusual — please report it.');
		default:
			return ('');
	}
}
